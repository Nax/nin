...
static void instruction(NinState* state)
{
    ...
    X("2666266727672666266626662676042600706737777727677777262637372626") { flagZ(state, tmp); }                                                /* Z */
    X("2666266726662666266626662676042600706737777727677777262637372626") { flagN(state, tmp); }                                                /* N */
