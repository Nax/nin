...
template<> CPU::Handler CPU::instruction<0x10b>(void) { _memory.ram[0x100 | _s--] = _a; return ((Handler)&CPU::dispatch); }
template<> CPU::Handler CPU::instruction<0x10c>(void) { _a = _memory.ram[0x100 | _s]; return ((Handler)&CPU::dispatch); }
template<> CPU::Handler CPU::instruction<0x10d>(void) { _s++; return ((Handler)&CPU::instruction<0x10c>); }
template<> CPU::Handler CPU::instruction<0x10e>(void) { _pc = (_addr | ((std::uint16_t)read(_pc) << 8)); return ((Handler)&CPU::dispatch); }
template<> CPU::Handler CPU::instruction<0x10f>(void) { _memory.ram[0x100 | _s--] = (_pc & 0xff); return ((Handler)&CPU::instruction<0x10e>); }
template<> CPU::Handler CPU::instruction<0x110>(void) { _memory.ram[0x100 | _s--] = (_pc >> 8); return ((Handler)&CPU::instruction<0x10f>); }
template<> CPU::Handler CPU::instruction<0x111>(void) { /* nop */ return ((Handler)&CPU::instruction<0x110>); }
template<> CPU::Handler CPU::instruction<0x112>(void) { read(_pc); _pc++; return ((Handler)&CPU::dispatch); }
template<> CPU::Handler CPU::instruction<0x113>(void) { _pc = (_pc & 0x00ff) | ((std::uint16_t)_memory.ram[0x100 | _s] << 8); return ((Handler)&CPU::instruction<0x112>); }
template<> CPU::Handler CPU::instruction<0x114>(void) { _pc = (_pc & 0xff00) | _memory.ram[0x100 | _s]; _s++; return ((Handler)&CPU::instruction<0x113>); }
template<> CPU::Handler CPU::instruction<0x115>(void) { _s++; return ((Handler)&CPU::instruction<0x114>); }
template<> CPU::Handler CPU::instruction<0x116>(void) { /* nop */ return ((Handler)&CPU::dispatch); }
template<> CPU::Handler CPU::instruction<0x117>(void) { if (!_addrCarry) return (Handler)&CPU::dispatch; _pc = _pc + (std::int8_t)_addr; return ((Handler)&CPU::instruction<0x116>); }
template<> CPU::Handler CPU::instruction<0x118>(void) { _memory.ram[_addr] = _regs[_selSrc]; return ((Handler)&CPU::dispatch); }
template<> CPU::Handler CPU::instruction<0x119>(void) { _addr = (_addr + _x) & 0xff; return ((Handler)&CPU::instruction<0x118>); }
template<> CPU::Handler CPU::instruction<0x11a>(void) { write(_addr, _regs[_selSrc]); return ((Handler)&CPU::dispatch); }
template<> CPU::Handler CPU::instruction<0x11b>(void) { _addr = ((_addr & 0x00ff) | ((std::uint16_t)read(_pc++)) << 8); return ((Handler)&CPU::instruction<0x11a>); }
template<> CPU::Handler CPU::instruction<0x11c>(void) { read(_addr); _addr += (((std::uint16_t)_addrCarry) << 8); return ((Handler)&CPU::instruction<0x11a>); }
template<> CPU::Handler CPU::instruction<0x11d>(void) { _addrCarry = (((_addr & 0xff) + _x) > 0xff) ? 1 : 0; _addr = (((_addr + _x) & 0x00ff) | ((std::uint16_t)read(_pc++)) << 8); return ((Handler)&CPU::instruction<0x11c>); }
template<> CPU::Handler CPU::instruction<0x11e>(void) { _addrCarry = (((_addr & 0xff) + _y) > 0xff) ? 1 : 0; _addr = (((_addr + _y) & 0x00ff) | ((std::uint16_t)read(_pc++)) << 8); return ((Handler)&CPU::instruction<0x11c>); }
template<> CPU::Handler CPU::instruction<0x11f>(void) { _addr = (_addr >> 8) | ((std::uint16_t)_memory.ram[(_addr + 1) & 0xff] << 8); return ((Handler)&CPU::instruction<0x11a>); }
template<> CPU::Handler CPU::instruction<0x120>(void) { _addr = _addr | ((std::uint16_t)_memory.ram[_addr] << 8); return ((Handler)&CPU::instruction<0x11f>); }
template<> CPU::Handler CPU::instruction<0x121>(void) { _addr = (_addr + _x) & 0xff; return ((Handler)&CPU::instruction<0x120>); }
template<> CPU::Handler CPU::instruction<0x122>(void) { _addr = (_addr >> 8) | ((std::uint16_t)_memory.ram[(_addr + 1) & 0xff] << 8); _addrCarry = (((_addr & 0xff) + _y) > 0xff) ? 1 : 0; _addr = (_addr & 0xff00) | ((_addr + _y) & 0xff); return ((Handler)&CPU::instruction<0x11c>); }
template<> CPU::Handler CPU::instruction<0x123>(void) { _addr = _addr | ((std::uint16_t)_memory.ram[_addr] << 8); return ((Handler)&CPU::instruction<0x122>); }
template<> CPU::Handler CPU::instruction<0x124>(void) { _addr = (_addr + _y) & 0xff; return ((Handler)&CPU::instruction<0x118>); }
template<> CPU::Handler CPU::instruction<0x125>(void) { _regs[_selDst] = _memory.ram[_addr]; flagNZ(_regs[_selDst]); return ((Handler)&CPU::dispatch); }
template<> CPU::Handler CPU::instruction<0x126>(void) { _addr = (_addr + _x) & 0xff; return ((Handler)&CPU::instruction<0x125>); }
template<> CPU::Handler CPU::instruction<0x127>(void) { _regs[_selDst] = read(_addr); flagNZ(_regs[_selDst]); return ((Handler)&CPU::dispatch); }
...
template<> CPU::Handler CPU::instruction<0x129>(void) { _regs[_selDst] = read(_addr); flagNZ(_regs[_selDst]); _addr += ((std::uint16_t)_addrCarry << 8); if (_addrCarry) return ((Handler)&CPU::dispatch); return ((Handler)&CPU::instruction<0x127>); }
...
template<> CPU::Handler CPU::instruction<0x132>(void) { std::uint8_t tmp = _memory.ram[_addr]; _regs[_selDst] |= tmp; flagNZ(_regs[_selDst]); return ((Handler)&CPU::dispatch); }
template<> CPU::Handler CPU::instruction<0x133>(void) { _addr = (_addr + _x) & 0xff; return ((Handler)&CPU::instruction<0x132>); }
template<> CPU::Handler CPU::instruction<0x134>(void) { std::uint8_t tmp = read(_addr); _regs[_selDst] |= tmp; flagNZ(_regs[_selDst]); return ((Handler)&CPU::dispatch); }
...
template<> CPU::Handler CPU::instruction<0x136>(void) { std::uint8_t tmp = read(_addr); if (!_addrCarry) { _regs[_selDst] |= tmp; flagNZ(_regs[_selDst]); return (Handler)&CPU::dispatch; } _addr += 0x100; return ((Handler)&CPU::instruction<0x134>); }
...
template<> CPU::Handler CPU::instruction<0x13e>(void) { std::uint8_t tmp = _memory.ram[_addr]; _regs[_selDst] &= tmp; flagNZ(_regs[_selDst]); return ((Handler)&CPU::dispatch); }
template<> CPU::Handler CPU::instruction<0x13f>(void) { _addr = (_addr + _x) & 0xff; return ((Handler)&CPU::instruction<0x13e>); }
template<> CPU::Handler CPU::instruction<0x140>(void) { std::uint8_t tmp = read(_addr); _regs[_selDst] &= tmp; flagNZ(_regs[_selDst]); return ((Handler)&CPU::dispatch); }
template<> CPU::Handler CPU::instruction<0x141>(void) { _addr = ((_addr & 0x00ff) | ((std::uint16_t)read(_pc++)) << 8); return ((Handler)&CPU::instruction<0x140>); }
template<> CPU::Handler CPU::instruction<0x142>(void) { std::uint8_t tmp = read(_addr); if (!_addrCarry) { _regs[_selDst] &= tmp; flagNZ(_regs[_selDst]); return (Handler)&CPU::dispatch; } _addr += 0x100; return ((Handler)&CPU::instruction<0x140>); }
template<> CPU::Handler CPU::instruction<0x143>(void) { _addrCarry = (((_addr & 0xff) + _x) > 0xff) ? 1 : 0; _addr = (((_addr + _x) & 0x00ff) | ((std::uint16_t)read(_pc++)) << 8); return ((Handler)&CPU::instruction<0x142>); }
template<> CPU::Handler CPU::instruction<0x144>(void) { _addrCarry = (((_addr & 0xff) + _y) > 0xff) ? 1 : 0; _addr = (((_addr + _y) & 0x00ff) | ((std::uint16_t)read(_pc++)) << 8); return ((Handler)&CPU::instruction<0x142>); }
template<> CPU::Handler CPU::instruction<0x145>(void) { _addr = (_addr >> 8) | ((std::uint16_t)_memory.ram[(_addr + 1) & 0xff] << 8); return ((Handler)&CPU::instruction<0x140>); }
template<> CPU::Handler CPU::instruction<0x146>(void) { _addr = _addr | ((std::uint16_t)_memory.ram[_addr] << 8); return ((Handler)&CPU::instruction<0x145>); }
template<> CPU::Handler CPU::instruction<0x147>(void) { _addr = (_addr + _x) & 0xff; return ((Handler)&CPU::instruction<0x146>); }
template<> CPU::Handler CPU::instruction<0x148>(void) { _addr = (_addr >> 8) | ((std::uint16_t)_memory.ram[(_addr + 1) & 0xff] << 8); _addrCarry = (((_addr & 0xff) + _y) > 0xff) ? 1 : 0; _addr = (_addr & 0xff00) | ((_addr + _y) & 0xff); return ((Handler)&CPU::instruction<0x142>); }
template<> CPU::Handler CPU::instruction<0x149>(void) { _addr = _addr | ((std::uint16_t)_memory.ram[_addr] << 8); return ((Handler)&CPU::instruction<0x148>); }
template<> CPU::Handler CPU::instruction<0x14a>(void) { std::uint8_t tmp = _memory.ram[_addr]; _regs[_selDst] ^= tmp; flagNZ(_regs[_selDst]); return ((Handler)&CPU::dispatch); }
template<> CPU::Handler CPU::instruction<0x14b>(void) { _addr = (_addr + _x) & 0xff; return ((Handler)&CPU::instruction<0x14a>); }
template<> CPU::Handler CPU::instruction<0x14c>(void) { std::uint8_t tmp = read(_addr); _regs[_selDst] ^= tmp; flagNZ(_regs[_selDst]); return ((Handler)&CPU::dispatch); }
template<> CPU::Handler CPU::instruction<0x14d>(void) { _addr = ((_addr & 0x00ff) | ((std::uint16_t)read(_pc++)) << 8); return ((Handler)&CPU::instruction<0x14c>); }
template<> CPU::Handler CPU::instruction<0x14e>(void) { std::uint8_t tmp = read(_addr); if (!_addrCarry) { _regs[_selDst] ^= tmp; flagNZ(_regs[_selDst]); return (Handler)&CPU::dispatch; } _addr += 0x100; return ((Handler)&CPU::instruction<0x14c>); }
template<> CPU::Handler CPU::instruction<0x14f>(void) { _addrCarry = (((_addr & 0xff) + _x) > 0xff) ? 1 : 0; _addr = (((_addr + _x) & 0x00ff) | ((std::uint16_t)read(_pc++)) << 8); return ((Handler)&CPU::instruction<0x14e>); }
template<> CPU::Handler CPU::instruction<0x150>(void) { _addrCarry = (((_addr & 0xff) + _y) > 0xff) ? 1 : 0; _addr = (((_addr + _y) & 0x00ff) | ((std::uint16_t)read(_pc++)) << 8); return ((Handler)&CPU::instruction<0x14e>); }
template<> CPU::Handler CPU::instruction<0x151>(void) { _addr = (_addr >> 8) | ((std::uint16_t)_memory.ram[(_addr + 1) & 0xff] << 8); return ((Handler)&CPU::instruction<0x14c>); }
template<> CPU::Handler CPU::instruction<0x152>(void) { _addr = _addr | ((std::uint16_t)_memory.ram[_addr] << 8); return ((Handler)&CPU::instruction<0x151>); }
template<> CPU::Handler CPU::instruction<0x153>(void) { _addr = (_addr + _x) & 0xff; return ((Handler)&CPU::instruction<0x152>); }
template<> CPU::Handler CPU::instruction<0x154>(void) { _addr = (_addr >> 8) | ((std::uint16_t)_memory.ram[(_addr + 1) & 0xff] << 8); _addrCarry = (((_addr & 0xff) + _y) > 0xff) ? 1 : 0; _addr = (_addr & 0xff00) | ((_addr + _y) & 0xff); return ((Handler)&CPU::instruction<0x14e>); }
template<> CPU::Handler CPU::instruction<0x155>(void) { _addr = _addr | ((std::uint16_t)_memory.ram[_addr] << 8); return ((Handler)&CPU::instruction<0x154>); }
template<> CPU::Handler CPU::instruction<0x156>(void) { std::uint8_t tmp = _memory.ram[_addr]; _p &= ~PFLAG_C; _p |= (_regs[_selDst] >= tmp) ? PFLAG_C : 0; flagNZ(_regs[_selDst] - tmp); return ((Handler)&CPU::dispatch); }
template<> CPU::Handler CPU::instruction<0x157>(void) { _addr = (_addr + _x) & 0xff; return ((Handler)&CPU::instruction<0x156>); }
template<> CPU::Handler CPU::instruction<0x158>(void) { std::uint8_t tmp = read(_addr); _p &= ~PFLAG_C; _p |= (_regs[_selDst] >= tmp) ? PFLAG_C : 0; flagNZ(_regs[_selDst] - tmp); return ((Handler)&CPU::dispatch); }
template<> CPU::Handler CPU::instruction<0x159>(void) { _addr = ((_addr & 0x00ff) | ((std::uint16_t)read(_pc++)) << 8); return ((Handler)&CPU::instruction<0x158>); }
template<> CPU::Handler CPU::instruction<0x15a>(void) { std::uint8_t tmp = read(_addr); if (!_addrCarry) { _p &= ~PFLAG_C; _p |= (_regs[_selDst] >= tmp) ? PFLAG_C : 0; flagNZ(_regs[_selDst] - tmp); return (Handler)&CPU::dispatch; } _addr += 0x100; return ((Handler)&CPU::instruction<0x158>); }
template<> CPU::Handler CPU::instruction<0x15b>(void) { _addrCarry = (((_addr & 0xff) + _x) > 0xff) ? 1 : 0; _addr = (((_addr + _x) & 0x00ff) | ((std::uint16_t)read(_pc++)) << 8); return ((Handler)&CPU::instruction<0x15a>); }
template<> CPU::Handler CPU::instruction<0x15c>(void) { _addrCarry = (((_addr & 0xff) + _y) > 0xff) ? 1 : 0; _addr = (((_addr + _y) & 0x00ff) | ((std::uint16_t)read(_pc++)) << 8); return ((Handler)&CPU::instruction<0x15a>); }
template<> CPU::Handler CPU::instruction<0x15d>(void) { _addr = (_addr >> 8) | ((std::uint16_t)_memory.ram[(_addr + 1) & 0xff] << 8); return ((Handler)&CPU::instruction<0x158>); }
template<> CPU::Handler CPU::instruction<0x15e>(void) { _addr = _addr | ((std::uint16_t)_memory.ram[_addr] << 8); return ((Handler)&CPU::instruction<0x15d>); }
template<> CPU::Handler CPU::instruction<0x15f>(void) { _addr = (_addr + _x) & 0xff; return ((Handler)&CPU::instruction<0x15e>); }
template<> CPU::Handler CPU::instruction<0x160>(void) { _addr = (_addr >> 8) | ((std::uint16_t)_memory.ram[(_addr + 1) & 0xff] << 8); _addrCarry = (((_addr & 0xff) + _y) > 0xff) ? 1 : 0; _addr = (_addr & 0xff00) | ((_addr + _y) & 0xff); return ((Handler)&CPU::instruction<0x15a>); }
template<> CPU::Handler CPU::instruction<0x161>(void) { _addr = _addr | ((std::uint16_t)_memory.ram[_addr] << 8); return ((Handler)&CPU::instruction<0x160>); }
template<> CPU::Handler CPU::instruction<0x162>(void) { _memory.ram[_addr] = _rmw; return ((Handler)&CPU::dispatch); }
template<> CPU::Handler CPU::instruction<0x163>(void) { std::uint8_t tmp = _rmw; _p &= ~(PFLAG_N | PFLAG_Z | PFLAG_C); _p |= ((tmp & 0x01) ? PFLAG_C : 0); tmp >>= 1; _p |= (tmp ? 0 : PFLAG_Z); _rmw = tmp; return ((Handler)&CPU::instruction<0x162>); }
template<> CPU::Handler CPU::instruction<0x164>(void) { _rmw = _memory.ram[_addr]; return ((Handler)&CPU::instruction<0x163>); }
template<> CPU::Handler CPU::instruction<0x165>(void) { _addr = (_addr + _x) & 0xff; return ((Handler)&CPU::instruction<0x164>); }
template<> CPU::Handler CPU::instruction<0x166>(void) { write(_addr, _rmw); return ((Handler)&CPU::dispatch); }
template<> CPU::Handler CPU::instruction<0x167>(void) { write(_addr, _rmw); std::uint8_t tmp = _rmw; _p &= ~(PFLAG_N | PFLAG_Z | PFLAG_C); _p |= ((tmp & 0x01) ? PFLAG_C : 0); tmp >>= 1; _p |= (tmp ? 0 : PFLAG_Z); _rmw = tmp; return ((Handler)&CPU::instruction<0x166>); }
template<> CPU::Handler CPU::instruction<0x168>(void) { _rmw = read(_addr); return ((Handler)&CPU::instruction<0x167>); }
...
template<> CPU::Handler CPU::instruction<0x16a>(void) { read(_addr); _addr += 0x100; return ((Handler)&CPU::instruction<0x168>); }
...
template<> CPU::Handler CPU::instruction<0x16c>(void) { std::uint8_t tmp = _rmw; flagNZ(++tmp); _rmw = tmp; return ((Handler)&CPU::instruction<0x162>); }
template<> CPU::Handler CPU::instruction<0x16d>(void) { _rmw = _memory.ram[_addr]; return ((Handler)&CPU::instruction<0x16c>); }
template<> CPU::Handler CPU::instruction<0x16e>(void) { _addr = (_addr + _x) & 0xff; return ((Handler)&CPU::instruction<0x16d>); }
template<> CPU::Handler CPU::instruction<0x16f>(void) { write(_addr, _rmw); std::uint8_t tmp = _rmw; flagNZ(++tmp); _rmw = tmp; return ((Handler)&CPU::instruction<0x166>); }
template<> CPU::Handler CPU::instruction<0x170>(void) { _rmw = read(_addr); return ((Handler)&CPU::instruction<0x16f>); }
template<> CPU::Handler CPU::instruction<0x171>(void) { _addr = ((_addr & 0x00ff) | ((std::uint16_t)read(_pc++)) << 8); return ((Handler)&CPU::instruction<0x170>); }
template<> CPU::Handler CPU::instruction<0x172>(void) { read(_addr); _addr += 0x100; return ((Handler)&CPU::instruction<0x170>); }
template<> CPU::Handler CPU::instruction<0x173>(void) { _addrCarry = (((_addr & 0xff) + _x) > 0xff) ? 1 : 0; _addr = (((_addr + _x) & 0x00ff) | ((std::uint16_t)read(_pc++)) << 8); return ((Handler)&CPU::instruction<0x172>); }
template<> CPU::Handler CPU::instruction<0x174>(void) { std::uint8_t tmp = _rmw; flagNZ(--tmp); _rmw = tmp; return ((Handler)&CPU::instruction<0x162>); }
template<> CPU::Handler CPU::instruction<0x175>(void) { _rmw = _memory.ram[_addr]; return ((Handler)&CPU::instruction<0x174>); }
template<> CPU::Handler CPU::instruction<0x176>(void) { _addr = (_addr + _x) & 0xff; return ((Handler)&CPU::instruction<0x175>); }
template<> CPU::Handler CPU::instruction<0x177>(void) { write(_addr, _rmw); std::uint8_t tmp = _rmw; flagNZ(--tmp); _rmw = tmp; return ((Handler)&CPU::instruction<0x166>); }
template<> CPU::Handler CPU::instruction<0x178>(void) { _rmw = read(_addr); return ((Handler)&CPU::instruction<0x177>); }
template<> CPU::Handler CPU::instruction<0x179>(void) { _addr = ((_addr & 0x00ff) | ((std::uint16_t)read(_pc++)) << 8); return ((Handler)&CPU::instruction<0x178>); }
template<> CPU::Handler CPU::instruction<0x17a>(void) { read(_addr); _addr += 0x100; return ((Handler)&CPU::instruction<0x178>); }
template<> CPU::Handler CPU::instruction<0x17b>(void) { _addrCarry = (((_addr & 0xff) + _x) > 0xff) ? 1 : 0; _addr = (((_addr + _x) & 0x00ff) | ((std::uint16_t)read(_pc++)) << 8); return ((Handler)&CPU::instruction<0x17a>); }
template<> CPU::Handler CPU::instruction<0x17c>(void) { std::uint8_t tmp = _memory.ram[_addr]; _p &= ~(PFLAG_Z | PFLAG_N | PFLAG_V); _p |= (tmp & 0xc0); _p |= ((_a & tmp) ? PFLAG_Z : 0); return ((Handler)&CPU::dispatch); }
template<> CPU::Handler CPU::instruction<0x17d>(void) { std::uint8_t tmp = read(_addr); _p &= ~(PFLAG_Z | PFLAG_N | PFLAG_V); _p |= (tmp & 0xc0); _p |= ((_a & tmp) ? PFLAG_Z : 0); return ((Handler)&CPU::dispatch); }
...
template<> CPU::Handler CPU::instruction<0x001>(void) { _selDst = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x13b>); }
...
template<> CPU::Handler CPU::instruction<0x005>(void) { _selDst = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x132>); }
...
template<> CPU::Handler CPU::instruction<0x00d>(void) { _selDst = REG_A; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x135>); }
...
template<> CPU::Handler CPU::instruction<0x010>(void) { _addr = read(_pc++); if (_p & PFLAG_N) { return (Handler)&CPU::dispatch; } _addrCarry = (((_pc + (std::int8_t)_addr) ^ _pc) & 0xff00) ? 1 : 0; _pc = ((_pc & 0xff00) | ((_pc + (std::int8_t)_addr) & 0xff)); return ((Handler)&CPU::instruction<0x117>); }
template<> CPU::Handler CPU::instruction<0x011>(void) { _selDst = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x13d>); }
...
template<> CPU::Handler CPU::instruction<0x015>(void) { _selDst = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x133>); }
...
template<> CPU::Handler CPU::instruction<0x019>(void) { _selDst = REG_A; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x138>); }
...
template<> CPU::Handler CPU::instruction<0x01d>(void) { _selDst = REG_A; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x137>); }
...
template<> CPU::Handler CPU::instruction<0x020>(void) { _addr = read(_pc++); return ((Handler)&CPU::instruction<0x111>); }
template<> CPU::Handler CPU::instruction<0x021>(void) { _selDst = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x147>); }
...
template<> CPU::Handler CPU::instruction<0x024>(void) { _addr = read(_pc++); return ((Handler)&CPU::instruction<0x17c>); }
template<> CPU::Handler CPU::instruction<0x025>(void) { _selDst = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x13e>); }
...
template<> CPU::Handler CPU::instruction<0x02c>(void) { _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x17e>); }
template<> CPU::Handler CPU::instruction<0x02d>(void) { _selDst = REG_A; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x141>); }
...
template<> CPU::Handler CPU::instruction<0x030>(void) { _addr = read(_pc++); if (!(_p & PFLAG_N)) { return (Handler)&CPU::dispatch; } _addrCarry = (((_pc + (std::int8_t)_addr) ^ _pc) & 0xff00) ? 1 : 0; _pc = ((_pc & 0xff00) | ((_pc + (std::int8_t)_addr) & 0xff)); return ((Handler)&CPU::instruction<0x117>); }
template<> CPU::Handler CPU::instruction<0x031>(void) { _selDst = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x149>); }
...
template<> CPU::Handler CPU::instruction<0x035>(void) { _selDst = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x13f>); }
...
template<> CPU::Handler CPU::instruction<0x039>(void) { _selDst = REG_A; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x144>); }
...
template<> CPU::Handler CPU::instruction<0x03d>(void) { _selDst = REG_A; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x143>); }
...
template<> CPU::Handler CPU::instruction<0x041>(void) { _selDst = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x153>); }
...
template<> CPU::Handler CPU::instruction<0x045>(void) { _selDst = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x14a>); }
template<> CPU::Handler CPU::instruction<0x046>(void) { _addr = read(_pc++); return ((Handler)&CPU::instruction<0x164>); }
template<> CPU::Handler CPU::instruction<0x047>(void) { return debug_not_impl(0x047); }
template<> CPU::Handler CPU::instruction<0x048>(void) { read(_pc); return ((Handler)&CPU::instruction<0x10b>); }
...
template<> CPU::Handler CPU::instruction<0x04c>(void) { _addr = read(_pc++); return ((Handler)&CPU::instruction<0x10e>); }
template<> CPU::Handler CPU::instruction<0x04d>(void) { _selDst = REG_A; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x14d>); }
template<> CPU::Handler CPU::instruction<0x04e>(void) { _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x169>); }
template<> CPU::Handler CPU::instruction<0x04f>(void) { return debug_not_impl(0x04f); }
template<> CPU::Handler CPU::instruction<0x050>(void) { _addr = read(_pc++); if (_p & PFLAG_V) { return (Handler)&CPU::dispatch; } _addrCarry = (((_pc + (std::int8_t)_addr) ^ _pc) & 0xff00) ? 1 : 0; _pc = ((_pc & 0xff00) | ((_pc + (std::int8_t)_addr) & 0xff)); return ((Handler)&CPU::instruction<0x117>); }
template<> CPU::Handler CPU::instruction<0x051>(void) { _selDst = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x155>); }
...
template<> CPU::Handler CPU::instruction<0x055>(void) { _selDst = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x14b>); }
template<> CPU::Handler CPU::instruction<0x056>(void) { _addr = read(_pc++); return ((Handler)&CPU::instruction<0x165>); }
...
template<> CPU::Handler CPU::instruction<0x059>(void) { _selDst = REG_A; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x150>); }
...
template<> CPU::Handler CPU::instruction<0x05d>(void) { _selDst = REG_A; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x14f>); }
template<> CPU::Handler CPU::instruction<0x05e>(void) { _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x16b>); }
template<> CPU::Handler CPU::instruction<0x05f>(void) { return debug_not_impl(0x05f); }
template<> CPU::Handler CPU::instruction<0x060>(void) { read(_pc); return ((Handler)&CPU::instruction<0x115>); }
...
template<> CPU::Handler CPU::instruction<0x068>(void) { read(_pc); return ((Handler)&CPU::instruction<0x10d>); }
...
template<> CPU::Handler CPU::instruction<0x070>(void) { _addr = read(_pc++); if (!(_p & PFLAG_V)) { return (Handler)&CPU::dispatch; } _addrCarry = (((_pc + (std::int8_t)_addr) ^ _pc) & 0xff00) ? 1 : 0; _pc = ((_pc & 0xff00) | ((_pc + (std::int8_t)_addr) & 0xff)); return ((Handler)&CPU::instruction<0x117>); }
...
template<> CPU::Handler CPU::instruction<0x081>(void) { _selSrc = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x121>); }
...
template<> CPU::Handler CPU::instruction<0x084>(void) { _selSrc = REG_Y; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x118>); }
template<> CPU::Handler CPU::instruction<0x085>(void) { _selSrc = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x118>); }
template<> CPU::Handler CPU::instruction<0x086>(void) { _selSrc = REG_X; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x118>); }
...
template<> CPU::Handler CPU::instruction<0x08c>(void) { _selSrc = REG_Y; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x11b>); }
template<> CPU::Handler CPU::instruction<0x08d>(void) { _selSrc = REG_A; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x11b>); }
template<> CPU::Handler CPU::instruction<0x08e>(void) { _selSrc = REG_X; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x11b>); }
template<> CPU::Handler CPU::instruction<0x08f>(void) { return debug_not_impl(0x08f); }
template<> CPU::Handler CPU::instruction<0x090>(void) { _addr = read(_pc++); if (_p & PFLAG_C) { return (Handler)&CPU::dispatch; } _addrCarry = (((_pc + (std::int8_t)_addr) ^ _pc) & 0xff00) ? 1 : 0; _pc = ((_pc & 0xff00) | ((_pc + (std::int8_t)_addr) & 0xff)); return ((Handler)&CPU::instruction<0x117>); }
template<> CPU::Handler CPU::instruction<0x091>(void) { _selSrc = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x123>); }
...
template<> CPU::Handler CPU::instruction<0x094>(void) { _selSrc = REG_Y; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x119>); }
template<> CPU::Handler CPU::instruction<0x095>(void) { _selSrc = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x119>); }
template<> CPU::Handler CPU::instruction<0x096>(void) { _selSrc = REG_X; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x124>); }
...
template<> CPU::Handler CPU::instruction<0x099>(void) { _selSrc = REG_A; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x11e>); }
...
template<> CPU::Handler CPU::instruction<0x09d>(void) { _selSrc = REG_A; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x11d>); }
...
template<> CPU::Handler CPU::instruction<0x0a1>(void) { _selDst = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x12e>); }
...
template<> CPU::Handler CPU::instruction<0x0a4>(void) { _selDst = REG_Y; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x125>); }
template<> CPU::Handler CPU::instruction<0x0a5>(void) { _selDst = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x125>); }
template<> CPU::Handler CPU::instruction<0x0a6>(void) { _selDst = REG_X; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x125>); }
...
template<> CPU::Handler CPU::instruction<0x0ac>(void) { _selDst = REG_Y; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x128>); }
template<> CPU::Handler CPU::instruction<0x0ad>(void) { _selDst = REG_A; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x128>); }
template<> CPU::Handler CPU::instruction<0x0ae>(void) { _selDst = REG_X; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x128>); }
template<> CPU::Handler CPU::instruction<0x0af>(void) { return debug_not_impl(0x0af); }
template<> CPU::Handler CPU::instruction<0x0b0>(void) { _addr = read(_pc++); if (!(_p & PFLAG_C)) { return (Handler)&CPU::dispatch; } _addrCarry = (((_pc + (std::int8_t)_addr) ^ _pc) & 0xff00) ? 1 : 0; _pc = ((_pc & 0xff00) | ((_pc + (std::int8_t)_addr) & 0xff)); return ((Handler)&CPU::instruction<0x117>); }
template<> CPU::Handler CPU::instruction<0x0b1>(void) { _selDst = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x130>); }
...
template<> CPU::Handler CPU::instruction<0x0b4>(void) { _selDst = REG_Y; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x126>); }
template<> CPU::Handler CPU::instruction<0x0b5>(void) { _selDst = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x126>); }
template<> CPU::Handler CPU::instruction<0x0b6>(void) { _selDst = REG_X; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x131>); }
...
template<> CPU::Handler CPU::instruction<0x0b9>(void) { _selDst = REG_A; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x12b>); }
...
template<> CPU::Handler CPU::instruction<0x0bc>(void) { _selDst = REG_Y; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x12a>); }
template<> CPU::Handler CPU::instruction<0x0bd>(void) { _selDst = REG_A; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x12a>); }
template<> CPU::Handler CPU::instruction<0x0be>(void) { _selDst = REG_X; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x12b>); }
...
template<> CPU::Handler CPU::instruction<0x0c1>(void) { _selDst = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x15f>); }
...
template<> CPU::Handler CPU::instruction<0x0c4>(void) { _selDst = REG_Y; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x156>); }
template<> CPU::Handler CPU::instruction<0x0c5>(void) { _selDst = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x156>); }
template<> CPU::Handler CPU::instruction<0x0c6>(void) { _addr = read(_pc++); return ((Handler)&CPU::instruction<0x175>); }
...
template<> CPU::Handler CPU::instruction<0x0cc>(void) { _selDst = REG_Y; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x159>); }
template<> CPU::Handler CPU::instruction<0x0cd>(void) { _selDst = REG_A; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x159>); }
template<> CPU::Handler CPU::instruction<0x0ce>(void) { _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x179>); }
template<> CPU::Handler CPU::instruction<0x0cf>(void) { return debug_not_impl(0x0cf); }
template<> CPU::Handler CPU::instruction<0x0d0>(void) { _addr = read(_pc++); if (_p & PFLAG_Z) { return (Handler)&CPU::dispatch; } _addrCarry = (((_pc + (std::int8_t)_addr) ^ _pc) & 0xff00) ? 1 : 0; _pc = ((_pc & 0xff00) | ((_pc + (std::int8_t)_addr) & 0xff)); return ((Handler)&CPU::instruction<0x117>); }
template<> CPU::Handler CPU::instruction<0x0d1>(void) { _selDst = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x161>); }
...
template<> CPU::Handler CPU::instruction<0x0d5>(void) { _selDst = REG_A; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x157>); }
template<> CPU::Handler CPU::instruction<0x0d6>(void) { _addr = read(_pc++); return ((Handler)&CPU::instruction<0x176>); }
...
template<> CPU::Handler CPU::instruction<0x0d9>(void) { _selDst = REG_A; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x15c>); }
...
template<> CPU::Handler CPU::instruction<0x0dd>(void) { _selDst = REG_A; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x15b>); }
template<> CPU::Handler CPU::instruction<0x0de>(void) { _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x17b>); }
...
template<> CPU::Handler CPU::instruction<0x0e4>(void) { _selDst = REG_X; _addr = read(_pc++); return ((Handler)&CPU::instruction<0x156>); }
template<> CPU::Handler CPU::instruction<0x0e5>(void) { return debug_not_impl(0x0e5); }
template<> CPU::Handler CPU::instruction<0x0e6>(void) { _addr = read(_pc++); return ((Handler)&CPU::instruction<0x16d>); }
...
template<> CPU::Handler CPU::instruction<0x0ec>(void) { _selDst = REG_X; _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x159>); }
template<> CPU::Handler CPU::instruction<0x0ed>(void) { return debug_not_impl(0x0ed); }
template<> CPU::Handler CPU::instruction<0x0ee>(void) { _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x171>); }
template<> CPU::Handler CPU::instruction<0x0ef>(void) { return debug_not_impl(0x0ef); }
template<> CPU::Handler CPU::instruction<0x0f0>(void) { _addr = read(_pc++); if (!(_p & PFLAG_Z)) { return (Handler)&CPU::dispatch; } _addrCarry = (((_pc + (std::int8_t)_addr) ^ _pc) & 0xff00) ? 1 : 0; _pc = ((_pc & 0xff00) | ((_pc + (std::int8_t)_addr) & 0xff)); return ((Handler)&CPU::instruction<0x117>); }
...
template<> CPU::Handler CPU::instruction<0x0f6>(void) { _addr = read(_pc++); return ((Handler)&CPU::instruction<0x16e>); }
...
template<> CPU::Handler CPU::instruction<0x0fe>(void) { _addr = ((_addr & 0xff00) | read(_pc++)); return ((Handler)&CPU::instruction<0x173>); }
...
template<> CPU::Handler CPU::instruction<0x102>(void) { _addr = 0xfffa; read(_pc); return ((Handler)&CPU::instruction<0x107>); }
...
const CPU::Handler CPU::kStates[] = {
    ...
    ((CPU::Handler)&CPU::instruction<0x17c>), ((CPU::Handler)&CPU::instruction<0x17d>), ((CPU::Handler)&CPU::instruction<0x17e>),
};
